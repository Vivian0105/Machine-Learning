...
Original file is located at
    https://colab.research.google.com/drive/1q1NPCudWXPnF_tagvLCFY_o9cZi29t_d
"""
...
def plot_learning_curves(train_losses, valid_losses, train_accuracies, valid_accuracies,cnnName):
    ...
    plt.ylabel("Accuracy")
    plt.xlabel("epoch")   
    plt.axis([0,len(train_accuracies)-1,0,100])
...
class ConvNet(nn.Module):
    def __init__(self):
        ...
        self.conv3= nn.Conv2d(30,40,2)
        self.fc1 = nn.Linear(40*3*3,300)
        self.fc2 = nn.Linear(300, 150)
        self.fc3 = nn.Linear(150, 80)
        self.fc4 = nn.Linear(80,11)
    def forward(self,x):
...
print(Y.shape, Y_valid.shape, Y_TEST.shape)
...
for epoch in range(num_epochs):
    ...
    valid_loss, valid_accuracy = evaluate(model, device, valid_loader, criterion)
...
plot_learning_curves(train_losses, valid_losses, train_accuracies, valid_accuracies,"CNN")
